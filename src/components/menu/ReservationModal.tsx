        ...
        try {
            await fetch('/api/reservations', {
                ...
                body: JSON.stringify({
                    ...
                    time: formData.time // Pass separate time field for API
                })
            });
            console.log('Prenotazione salvata in background');
        } catch (error) {
        ...
        <div className={styles.overlay} onClick={onClose}>
            <div className={styles.modal} onClick={e => e.stopPropagation()}>
                <div className={styles.header}>
                    <h3 className={styles.title}>Prenota un Tavolo</h3>
                    <p className={styles.subtitle}>Compila per inviare richiesta su WhatsApp</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className={styles.form}>
                    ...
                    <div className={styles.inputGroup}>
                        <label className={styles.label}>Numero Ospiti</label>
                        <input
                            required
                            type="number"
                            min="1"
