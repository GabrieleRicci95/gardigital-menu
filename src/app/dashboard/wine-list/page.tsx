        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '2rem 1rem', paddingBottom: '120px', fontFamily: 'var(--font-inter, sans-serif)' }}>
            ...
            <header style={{ marginBottom: '3rem', textAlign: 'center' }}>
                <div style={{
                    width: '60px',
                    height: '60px',
                    background: 'linear-gradient(135deg, #722f37 0%, #a31d1d 100%)', // Wine Red gradient
                    borderRadius: '20px',
                    display: 'flex',
                    alignItems: 'center',
                ...
                <p style={{ color: '#666', fontSize: '1.1rem', maxWidth: '600px', margin: '0 auto' }}>
                    Gestisci la tua cantina digitale. Organizza le bottiglie per categorie (Rossi, Bianchi, Rosati) e presentale con eleganza.
                </p>
            </header>
                                        ...
                                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                                            <div>
                                                <input
                                                    ...
                                                    placeholder="Nome Vino (es. Chianti Classico)"
                                                    style={{
                                                        width: '100%',
                                                        padding: '10px 0',
                                                        borderRadius: '0',
                                            ...
                                            <div>
                                                <input
                                                    ...
                                                    placeholder="Descrizione (es. Note di ciliegia, 2018, Toscana)"
                                                    style={{
                                                        width: '100%',
                                                        padding: '8px',
                                                        borderRadius: '8px',
                                                    ...
                                                    onFocus={(e) => {
                                                        ...
                                                        e.target.style.boxShadow = '0 0 0 3px rgba(163, 29, 29, 0.1)';
                                                    }}
                                                    onBlur={(e) => {
