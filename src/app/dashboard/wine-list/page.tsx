...
function SortableSection({ section, index, children }: { section: WineSection; index: number; children: (dragHandleProps: any) => React.ReactNode }) {
    ...
    return (
        <div className={styles.container} style={{ paddingBottom: '140px' }}>
            ...
            <DndContext sensors={sensors} collisionDetection={closestCenter} onDragEnd={handleDragEnd}>
                <SortableContext items={wineList.sections.map((s, idx) => s.id || `section-${idx}`)} strategy={verticalListSortingStrategy}>
