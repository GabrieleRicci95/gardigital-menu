                                    ...
                                    <div style={{ padding: '1.5rem', background: '#f9fafb', borderRadius: '12px', border: '1px solid #e5e7eb', marginBottom: '1.5rem' }}>
                                        <form onSubmit={handleAddItem}>
                                            ...
                                            <div style={{ display: 'flex', gap: '1rem', marginBottom: '1rem' }}>
                                                ...
                                                {(restaurantSlug.includes('gaspare') || restaurantSlug.includes('bernardi') || restaurantSlug.includes('mastro')) && (
                                                    <input
                                                        placeholder="Unità (es. cad, hg)"
                                                ...
                                                <form onSubmit={(e) => handleUpdateItem(e, item.id)}>
                                                    <div style={{ display: 'flex', gap: '1rem', marginBottom: '1rem', marginTop: '1rem' }}>
                                                        ...
                                                        {(restaurantSlug.includes('gaspare') || restaurantSlug.includes('bernardi') || restaurantSlug.includes('mastro')) && (
                                                            <input
                                                                placeholder="Unità (es. cad, hg)"
                                                                value={editItemData.priceUnit}
                                                                onChange={e => setEditItemData({ ...editItemData, priceUnit: e.target.value })}
                                                                className={styles.input}
                                                                style={{ flex: 1 }}
                                                            />
                                                        )}
