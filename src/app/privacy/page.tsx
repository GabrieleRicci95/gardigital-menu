                ...
                <div className={styles.content}>
                    ...
                    <div className={styles.text}>
                        ...
                        <section className={styles.section}>
                            ...
                            <p className={styles.text}>
                                Per domande sulla privacy, contattaci all'indirizzo email: <a href="mailto:gardigital16@gmail.com" style={{ color: 'var(--color-primary)', textDecoration: 'underline' }}>gardigital16@gmail.com</a>.
                            </p>
                        </section>
                    </div>
                </div>
